...
ag.transaksi,
round (ag.sum_sales/ag.count_day, 2) produktivitas,
round (ag.transaksi/ag.count_day, 2) transaksi_per_day,
round (ag.sum_sales/ag.transaksi, 2) basket_size,
r. rank_store
from agg_transaksi ag
left join ranking r
on ag.store_nbr = r.store_nbr
order by rank_store, basket_size;
